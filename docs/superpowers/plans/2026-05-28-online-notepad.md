...
> **2026-06-08 整理状态：** 本计划是项目初始实现计划。当前仓库已完成计划中的基础功能，并已演进到 `0.4.30`；下面的原始步骤已按现有仓库状态统一标记为完成。后续新增需求请以 `AGENTS.md`、`CHANGELOG.md` 和新的计划/任务记录为准。
...
- [x] **Step 3: 实现 notes 和 tags routes**
